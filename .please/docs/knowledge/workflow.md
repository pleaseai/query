...
> Development workflow conventions for the query project.
...
bun run test                    # Via vitest (verbose)
```
...
- Verify search quality with benchmark fixtures
- Test provider implementations (AI SDK, local)
